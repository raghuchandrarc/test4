...
import com.mnt.webbanking.ReportUtils.GetScreenShot;
...
import com.mnt.webbanking.Utils.Log4j;
...
public class TestController extends Resources {
	...
	public void TestCaseController() throws Exception {
		...
		ReportUtil.startTesting(
				System.getProperty("user.dir") + "//src//test//java//com//mnt//webbanking//Reports//index.html",
				startTime, "Test", "1.5");
